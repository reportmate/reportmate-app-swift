...
enum Route: Hashable {
    ...
    /// This Mac's own report from the runner cache, opened on a tab.
    case localDevice(tab: DeviceTab?, filter: String?)

    static let thisMac = Route.localDevice(tab: nil, filter: nil)
